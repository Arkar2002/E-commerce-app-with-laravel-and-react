...
<body id="page-top">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                @else
                                    ...
                                    @else
                                        <img class="img-profile rounded-circle"
                                            src="{{ asset('/images/default_user_female.png') }}">
                                    @endif
                                @endif
                            </a>
    ...
    <script>
        $(document).ready(function() {
            $sidebarToggle = JSON.parse(localStorage.getItem("sidebar-toggle"));
            ...
            $("#sidebarToggle").click(function() {
                $sidebarToggle = JSON.parse(localStorage.getItem("sidebar-toggle"));
                localStorage.setItem("sidebar-toggle", JSON.stringify(!$sidebarToggle));
            })
        })
    </script>
    @yield('script')
