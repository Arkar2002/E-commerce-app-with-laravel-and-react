                    ...
                    <div class="card p-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="qty" name="qty" value="{{ old('qty') }}"
                                class="form-control @error('qty') is-invalid @enderror" placeholder="Total Quantity">
                            @error('qty')
                                <span class="invalid-feedback">Total Quantity field is required</span>
                            @enderror
                        </div>
                        <div class="form-group">
                    ...
                    <div class="card p-4">
                        ...
                        <div class="form-group">
                            ...
                            <select id="brand" id="brand_id" name="brand_id" class="form-control">
                                @foreach ($brands as $b)
                                    <option value="{{ $b->id }}">{{ Str::ucfirst($b->name) }}</option>
                                @endforeach
                            </select>
                        </div>
